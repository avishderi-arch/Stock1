...
.sector-card  { background:#161b22; border:1px solid #30363d; border-radius:8px; padding:10px 14px; margin:4px 0; }
...
def show_card(i, row, style="normal", show_earnings=False):
    ...
    <div class="{card_cls}">
      ...
      <div class="row-item">📏 שיא 52W: ${row['high52']} (מרחק: {row.get('dist_52h','-')}%)</div>
